...
import { sendEmail, useArmedTracker } from '../Queries';
import { ArmedDocument } from './ArmedDocument';
...
const ArmedCertificates: FC<TerminologyProps> = () => {
...
export default ArmedCertificates
